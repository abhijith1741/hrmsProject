...
<div class="wrapper">
 ...
 %>
  ...
  <form action="<%=request.getContextPath()%>/newAdministrator" method="post">
  <div class="container">
    <h1>Sign Up</h1>
    ...
    <div class="clearfix">
      <button type="button" class="cancelbtn"  onclick="window.location.href ='admin.jsp';">Cancel</button> 
